...
Spacebrew.Client=function(a,b,d,c){c=c||{};void 0!=a&&"[object String]"!==toString.call(a)&&(c.port=a.port||void 0,c.debug=a.debug||!1,c.reconnect=a.reconnect||!1,d=a.description||void 0,b=a.name||void 0,a=a.server||void 0);this.debug=!1;window&&(this.debug="true"===window.getQueryString("debug")?!0:c.debug||!1);this.reconnect=c.reconnect||!0;this.reconnect_timer=void 0;this.sendRateCapped=void 0===c.capSendRate?!1:c.capSendRate;this.send_interval=c.sendRate||16;this.send_blocked=!1;this.msg={};this._name=
b||"javascript client #";window&&(this._name=""!==window.getQueryString("name")?unescape(window.getQueryString("name")):this._name);this._description=d||"spacebrew javascript client";window&&(this._description=""!==window.getQueryString("description")?unescape(window.getQueryString("description")):this._description);this.server=a||"sandbox.spacebrew.cc";window&&(this.server=""!==window.getQueryString("server")?unescape(window.getQueryString("server")):this.server);this.port=c.port||9E3;window&&(a=
window.getQueryString("port"),""===a||isNaN(a)||(this.port=a));this.socket=null;this.client_config={name:this._name,description:this._description,publish:{messages:[]},subscribe:{messages:[]},options:{}};this.admin={};this._isConnected=!1};
...
Spacebrew.Client.prototype.close=function(){try{this._isConnected&&(this.socket.close(),this._isConnected=!1,console.log("[close:Spacebrew] closing websocket connection"))}catch(a){this._isConnected=!1}};Spacebrew.Client.prototype.onOpen=function(a,b){};Spacebrew.Client.prototype.onClose=function(a,b){};Spacebrew.Client.prototype.onRangeMessage=function(a,b){};Spacebrew.Client.prototype.onBooleanMessage=function(a,b){};Spacebrew.Client.prototype.onStringMessage=function(a,b){};
Spacebrew.Client.prototype.onCustomMessage=function(a,b,d){};Spacebrew.Client.prototype.addPublish=function(a,b,d){this.client_config.publish.messages.push({name:a,type:b,"default":d});this.updatePubSub()};Spacebrew.Client.prototype.addSubscribe=function(a,b){this.client_config.subscribe.messages.push({name:a,type:b});this.updatePubSub()};Spacebrew.Client.prototype.updatePubSub=function(){this._isConnected&&this.socket.send(JSON.stringify({config:this.client_config}))};
Spacebrew.Client.prototype.send=function(a,b,d){var c=this;this.msg={message:{clientName:this._name,name:a,type:b,value:d}};this.sendRateCapped?this.send_blocked||(this.socket.send(JSON.stringify(this.msg)),this.send_blocked=!0,this.msg=void 0,setTimeout(function(){c.send_blocked=!1;void 0!=c.msg&&c.send(c.msg.message.name,c.msg.message.type,c.msg.message.value)},c.send_interval)):this.socket.send(JSON.stringify(this.msg))};
...
Spacebrew.Client.prototype._onMessage=function(a){var b=JSON.parse(a.data),d;console.log("_onMessage ",a);if(("targetType"in b||b instanceof Array)&&"client"!=b.targetType)this.admin.active&&this._handleAdminMessages(b);else if("message"in b)switch(a=b.message.name,d=b.message.type,b=b.message.value,d){case "boolean":this.onBooleanMessage(a,"true"==b);break;case "string":this.onStringMessage(a,b);break;case "range":this.onRangeMessage(a,Number(b));break;default:this.onCustomMessage(a,b,d)}};
